...
<div id="events" class="section-wrapper" >
    <div id="events-section" style="padding: 6rem 0 8rem;">
        ...
        <div class="box">
            ...
            <iframe :src="'https://player.vimeo.com/video/<?php echo $recent['vimeo']; ?>?autoplay=1&title=0&byline=0&portrait=0'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
        </div>
        <?php }else{ ?>
            <div class="box" >
